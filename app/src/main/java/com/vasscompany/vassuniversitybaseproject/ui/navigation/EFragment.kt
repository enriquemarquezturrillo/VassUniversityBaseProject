...
import com.vasscompany.vassuniversitybaseproject.databinding.FragmentNavigationEBinding
...
@AndroidEntryPoint
class EFragment : BaseFragment<FragmentNavigationEBinding>() {

    private val navViewModel: NavViewModel by viewModels()
    private val args: EFragmentArgs by navArgs()

    override fun inflateBinding() {
        binding = FragmentNavigationEBinding.inflate(layoutInflater)
    }
    ...
    override fun createViewAfterInflateBinding(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?) {
        ...
        binding?.btNav?.setOnClickListener {
            findNavController().navigate(EFragmentDirections.actionEfragmentToFfragment("Vamos hacía delante"))
        }
    }
    ...
    override fun configureToolbarAndConfigScreenSections() {
        ...
        showToolbar(title = getString(R.string.navigation_fragment_e), showBack = true)
    }
